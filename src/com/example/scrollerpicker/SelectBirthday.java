package com.example.scrollerpicker;
...
public class SelectBirthday extends PopupWindow implements OnClickListener {
	...
	public SelectBirthday(Activity context,Handler handler,String data,int flag) {
		super(context);
		mHandler = handler;
		mContext = context;
		viewFlag = flag;
		...
		if(null==data||data.equals("")){
			...
			this.age = new StringBuilder().append(mYear).append("-")
